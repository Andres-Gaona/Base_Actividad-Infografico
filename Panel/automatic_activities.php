...
<link href="https://fonts.googleapis.com/css?family=Open+Sans:400,600,800|Roboto+Slab:400,700" rel="stylesheet">
       ...
       <script type="text/javascript" src="../js/reload_page.js"></script>
    <script>
...
<script type="text/javascript">
            ...
            $(window).on('load', function() { // Se asegura que todo el sítio este cargado
                $('#status').delay(1000).fadeOut('slow'); // Efecto que desvanece la animación de cargado
                $('#preloader').delay(2500).fadeOut('slow'); // Desvanece pantalla blanca
                $('body').delay(2500).css({'overflow':'visible'});
                $('.total_content').delay(2500).css({'visibility':'visible'});
    ...
    <script src="../js/carousellite/lib/jquery.easing.js"></script>
    <script src="../js/carousellite/lib/jquery.easing.compatibility.js"></script>
    <script src="../js/carousellite/lib/jquery.mousewheel.js"></script>
...
<div class="flag_tide yellow_flag" >
            ...
            Lunes, 12 de Enero<br/>                  
                  
                </div>
              <div class="date_eng">
                
            Monday, January 12<span class="date_apos">th</span>                  
...
<div id="total_phones_rotator" class="owl-carousel">
  ...
  <div class="side_box">
    <div id="promo_rotator" class="show_rotator_box owl-carousel">
        ...
        <div class="item">
            <iframe scrolling="no" frameborder="0" src="\Act+Inf\Infografico\shows.php\shows.php lunes\PanInfo\shows.php" style="width: 478px; height: 640px"></iframe>
        
        </div>
                 
        <div class="item">
            <iframe scrolling="no" frameborder="0" src="\Act+Inf\Infografico\shows.php\shows.php martes\PanInfo\shows.php" style="width: 478px; height: 640px"></iframe>
        
        </div>
                 
        <div class="item">
            <iframe scrolling="no" frameborder="0" src="\Act+Inf\Infografico\shows.php\shows.php miercoles\PanInfo\shows.php" style="width: 478px; height: 640px"></iframe>
        
        </div>
                 
        <div class="item">
            <iframe scrolling="no" frameborder="0" src="\Act+Inf\Infografico\shows.php\shows.php jueves\PanInfo\shows.php" style="width: 478px; height: 640px"></iframe>
        
        </div>
                 
        <div class="item">
            <iframe scrolling="no" frameborder="0" src="\Act+Inf\Infografico\shows.php\shows.php viernes\PanInfo\shows.php" style="width: 478px; height: 640px"></iframe>
        
        </div>
                 
        <div class="item">
            <iframe scrolling="no" frameborder="0" src="\Act+Inf\Infografico\shows.php\shows.php sabado\PanInfo\shows.php" style="width: 478px; height: 640px"></iframe>
        
        </div>
                 
        <div class="item">
            <iframe scrolling="no" frameborder="0" src="\Act+Inf\Infografico\shows.php\shows.php domingo\PanInfo\shows.php" style="width: 478px; height: 640px"></iframe>
    ...
    <div class="video_box">
      ...
      <iframe class="video_frame" src="video.php" scrolling="no" frameborder="0"></iframe>
...
<div id="rotator_especial" class="owl-carousel">
        ...
        <div class="promo_total_content">
          ...
          <div class="promo_picture">
            <div class="promo_shadow_right"></div>
									<img src="..\promos\QR CCN_Barceló Huatulco_w360_h258\QR CCN_Barceló Huatulco_08260737.jpg" width="360" height="258" alt="" >
      ...
      <div class="promo_box">
        ...
        <div class="promo_total_content">
          ...
          <div class="promo_picture">
            <div class="promo_shadow_right"></div>
									<img src="..\promos\App Barceló Huatulco_3_w360_h258\App Barceló Huatulco_3_07181101.jpg" width="360" height="258" alt="" >
      ...
      <div class="promo_box">
        ...
        <div class="promo_total_content">
          ...
          <div class="promo_picture">
            <div class="promo_shadow_right"></div>
									<img src="..\promos\modificar_1_w360_h258\modificar_1_12190152.jpg" width="360" height="258" alt="" >
      ...
      <div class="promo_box">
        ...
        <div class="promo_total_content">
          ...
          <div class="promo_picture">
            <div class="promo_shadow_right"></div>
									<img src="..\promos\modificar_2_w360_h258\modificar_2_12190154.jpg" width="360" height="258" alt="" >
...
<div class="restaurat_box"> 
            ...
            <div class="rest_tittle">
              <div class="rest_tittle_content">DESAYUNO / BREAKFAST</div>
                 ...
                 <li>
                  ...
                  <div class="rest_row">
        <div class="inline_block no_reserve" ></div><div class="inline_block rest_text rest_name_list">Doña Rosa</div><div class="inline_block rest_text type_rest_line">Buffet / Buffet</div>
    ...
    <div class="dress_code_box inline_block">Casual</div>
                 ...
                 <li>
                  ...
                  <div class="rest_row">
        <div class="inline_block no_reserve" ></div><div class="inline_block rest_text rest_name_list">El Agave</div><div class="inline_block rest_text type_rest_line">Buffet / Buffet</div>
    ...
    <div class="dress_code_box inline_block">Casual</div>
                 ...
                 <li>
                  ...
                  <div class="rest_row">
        <div class="inline_block no_reserve" ></div><div class="inline_block rest_text rest_name_list">La Tortuga</div><div class="inline_block rest_text type_rest_line">Buffet / Buffet</div>
...
<li>
    ...
    <div class="inline_block rest_text reserve_line" style="background-color: #F15A2A; width: 32px;">R</div>
                                            ...
                                            <div class="inline_block rest_text rest_name_list">Kyoto</div><div class="inline_block rest_text type_rest_line">Sushi Bar / Sushi Bar</div>
    ...
    <div class="inline_block rest_text reserve_line" style="background-color: #F15A2A; width: 32px;">R</div>
                                            ...
                                            <div class="inline_block rest_text rest_name_list">El Agave</div><div class="inline_block rest_text type_rest_line">Mexicano / Mexican</div>
    ...
    <div class="inline_block rest_text reserve_line" style="background-color: #F15A2A; width: 32px;">R</div>
                                            ...
                                            <div class="inline_block rest_text rest_name_list">La Fontana</div><div class="inline_block rest_text type_rest_line">Italiano / Italian</div>
    ...
    <div class="inline_block rest_text reserve_line" style="background-color: #F15A2A; width: 32px;">R</div>
                                            ...
                                            <div class="inline_block rest_text rest_name_list">Sea food</div><div class="inline_block rest_text type_rest_line">Carnes y Mariscos / Meat cuts and Seafood</div>
    ...
    <div class="dress_code_box inline_block">Casual</div>
          ...
          <div class="rest_tittle" style="background-color: #531C51">
              <div class="rest_tittle_content" style="background-color: #3C143A">BARES / BARS</div>
                      ...
                      <div class="rest_row">
                                                <div class="inline_block no_reserve" ></div><div class="inline_block rest_text rest_name_list">Lobby Bar </div><div class="inline_block rest_text type_rest_line"></div>
                      ...
                      <div class="rest_row">
                                                <div class="inline_block no_reserve" ></div><div class="inline_block rest_text rest_name_list">Pool Bar</div><div class="inline_block rest_text type_rest_line"></div>
                      ...
                      <div class="rest_row">
                                                <div class="inline_block no_reserve" ></div><div class="inline_block rest_text rest_name_list">Bar Jorongo</div><div class="inline_block rest_text type_rest_line"></div>
                      ...
                      <div class="rest_row">
                                                <div class="inline_block no_reserve" ></div><div class="inline_block rest_text rest_name_list">Bar Teatro</div><div class="inline_block rest_text type_rest_line"></div>
